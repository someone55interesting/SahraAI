...
# Динамически подставляем URL базы данных из нашего .env файла
...
# Передаем метаданные наших моделей Alembic'у для отслеживания изменений
...
def do_run_migrations(connection) -> None:
    """Вспомогательная функция для применения миграций внутри асинхронного соединения."""
